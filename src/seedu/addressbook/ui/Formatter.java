...
public class Formatter {
    ...
    public String getFormattedMessages(String... message) {
    	StringBuilder builder = new StringBuilder();
        for (String m : message) {
        	builder.append(getMessageLine(m));
        	builder.append(LS);
        }
    ...
    public String getMessageLine(String m){
    ...
    public String getEnteredMessage(String fullInputLine){
    	return "[Command entered:" + fullInputLine + "]";
    }
    
    public String getGoodbyeMsg(){
    	return getFormattedMessages(MESSAGE_GOODBYE, DIVIDER, DIVIDER);
    }
    
    public String getInitFailMsg(){
    	return getFormattedMessages(MESSAGE_INIT_FAILED, DIVIDER, DIVIDER);
    }
    
    public String getResultMsg(CommandResult result){
        return getFormattedMessages(result.feedbackToUser, DIVIDER);
    }
